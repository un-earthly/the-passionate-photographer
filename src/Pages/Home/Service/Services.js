    ...
    return (
        <div>
            ...
            <div className='grid md:grid-cols-3 grid-cols-1 gap-7 px-8 py-4'>
                ...
                <Service name='Modeling Photography' img='images/Compressed/fashion-4.jpg' pricing='$23.99' desc="To Become a succesful model you need a right photographer who can capture the hindden start within you.I'd like to capture that hiddine You. Lets Start the journey of Shine Along!!" />
            </div>
        </div>
    )
}
